#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
# User guide to install and run the Elmer/Ice - NEMO coupled model.
#
# To donload the full package, do:
...
#   - 12/2017: Add README files and multuiple EXP cases (Nicolas Jourdain)
...
# Put the correct modules and environment variables in your .bashrc 
# ( alternatively, put them in a .sh script and source it each time you
#   work with NEMO-Elmer/Ice).
