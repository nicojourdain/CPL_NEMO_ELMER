...
NRUN_MAX=600  # maximum number of consecutive Elmer/Ice runs

ELMER_MESH_NAME=MISMIP_REGULAR

TIME_STEP_ELMER=0.0833333333         # ELMER time step (in yr)
INTERVALS_ELMER=2                    # duration of ELMER run (in nb time steps)
...
FORCING_EXP_ID='EXP11'  ## ='EXP3' for ocean relaxation towards warm conditions 
...
RST_FILE="/store/njourd/RESTART_NEMO_FOR_MISOMIP/restart_ISOMIP1km_${FEID}_TKE_02233800.nc"
...
BATHY_FILE=/scratch/shared/egige60/input/nemo_ISOMIP1km/BATHY_ISF_EXP5/bathy_meter_ISOMIP1km_EXP5.nc
#ISF_DRAFT_GENERIC=${WORKDIR_NEMO}/input/isf_draft_meter.nc
ISF_DRAFT_GENERIC=/scratch/shared/egige60/input/nemo_ISOMIP1km/BATHY_ISF_EXP5/isf_draft_meter_ISOMIP1km_EXP5.nc
