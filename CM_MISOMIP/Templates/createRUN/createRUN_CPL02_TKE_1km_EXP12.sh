...
FORCING_EXP_ID='EXP12'  ## ='EXP3' for ocean relaxation towards warm conditions 
...
RST_FILE="/store/njourd/RESTART_NEMO_FOR_MISOMIP/restart_ISOMIP1km_${FEID}_TKE_02102400.nc"
